...
import com.personal.animeshpandey.vocabpro.feature_dictionary.dependencyInjection.WordModule
...
fun WordItem(
    ...
    Column(modifier = modifier) {
        ...
        wordInfo.meanings.forEach { meaning ->
            Text(text = meaning.partsOfSpeech, fontWeight = FontWeight.Bold)
